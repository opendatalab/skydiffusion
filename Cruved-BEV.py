...
def main():
    ...
    # Skydiffusion can use Cruved-BEV converted images for subsequent satellite generation in steps.
    # Of course, it is also possible to use the original street view image as input and then convert it to BEV results.
